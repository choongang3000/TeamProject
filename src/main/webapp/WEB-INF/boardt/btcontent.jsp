...
<%-- 		<tr  height="50" style="border-bottom: 1px dotted gray">
		...
		<tr height="50" style="border-bottom: 1px dotted gray" align="center">
			...
			<td width="60%" align="center">
				<img id="img1" src="<%=request.getContextPath() %>/resources/images/${bt.quizimg}" width="200px" height="200px">
				<img id="img2" src="<%=request.getContextPath() %>/resources/images/${bt.examfile}" width="300px" height="200px">
				<img id="img3" src="<%=request.getContextPath() %>/resources/images/${bt.movingimg}" width="200px" height="200px">
			</td>
		</tr>		
		<tr  height="50" style="border-bottom: 1px dotted gray">
			<td style="border-right: 1px dotted gray" width="20%">
