  ...
  <main>
    ...
    <div class="row g-5">
      <div class="d-block mx-auto mb-6">
        ...
        <form class="needs-validation" method="post" action="coinsert.ad" enctype="multipart/form-data">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="file" class="form-control" name="upvideo">
              <div class="invalid-feedback">
                강의 영상을 넣어주세요.
              </div>
            </div>
            ...
            <div class="col-3">
              ...
              <input type="text" class="form-control" name="coprice">
            </div>
