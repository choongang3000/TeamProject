          ...
          <div class="row g-3">	
            ...
            <div class="col-8">
             ...
             <div class="col-4">
              ...
              <div class="input-group has-validation">
                <!-- <span class="input-group-text">@</span> -->
                <input type="text" name="aname" class="form-control" value="${membean.aname }" required>
              <div class="invalid-feedback">
                  이름을 작성해주세요.
                </div>
              </div>
            ...
            <div class="col-6">
              ...
              <div class="input-group has-validation">
                <!-- <span class="input-group-text">@</span> -->
                <input type="text" name="rrn1" class="form-control" value="${membean.rrn1 }" required>
                &nbsp;<b>-</b>&nbsp;
           		<input type="text" name="rrn2" class="form-control" value="${membean.rrn2 }" required>
              </div>
            </div>
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                <!-- <span class="input-group-text">@</span> -->
                <input type="text" name="email" class="form-control" value="${membean.email }" required>
              <div class="invalid-feedback">
                  E-mail을 작성해주세요.
                </div>
              </div>
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                <!-- <span class="input-group-text">@</span> -->
                <input type="text" name="phone1" class="form-control" value="${membean.phone1 }" required>
                &nbsp;<b>-</b>&nbsp;
                <input type="text" name="phone2" class="form-control" value="${membean.phone2 }" required>
                &nbsp;<b>-</b>&nbsp;
                <input type="text" name="phone3" class="form-control" value="${membean.phone3 }" required>
              <div class="invalid-feedback">
                  전화번호를 입력해주세요.
                </div>
              </div>
            ...
            <div class="col-4">
              ...
              <div class="input-group has-validation">
                <input type="text" class="form-control" id="sample4_postcode" name="addr_num" placeholder="우편번호" value="${membean.getAddr_num }">
				&nbsp;&nbsp;
            ...
            <div class="col-8">
              ...
              <div class="input-group has-validation">
                <!-- <span class="input-group-text">@</span> -->
              	<input type="text" class="form-control" id="sample4_roadAddress" name="addr_first" placeholder="도로명주소" value="${membean.getAddr_first }">   
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="input-group has-validation">
                <!-- <span class="input-group-text">@</span> -->
              	<input type="text" class="form-control" name="addr_last" placeholder="나머지 주소 작성" value="${membean.getAddr_last }">   
              </div>
            </div>
            ...
            <button class="w-50 btn btn-secondary btn-mg" type="button" onClick="history.back()">로그인 하러 가기</button>
            <button class="w-50 btn btn-primary btn-mg" type="submit" onClick="return check()">계정 생성</button>
